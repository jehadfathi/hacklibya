...
║ Telegram : https://t.me/jehadarteeb
║ Version  : 0.1                      
║ FILENAME : hklibya                       
╚══════════════════════════════════════════╝
...
def chk():
  ...
  try: 
    ...
    if id in httpCaht: 
      ...
      os.system('xdg-open  https://wa.me/218921762445?text=*Hello*%2C%20*Okenwa*%20*i*%20*want*%20*to*%20*buy*%20*your*%20*command*%20*apk*%20*UPDATED*')
      time.sleep(1) 
      sys.exit() 
  except: 
    sys.exit() 
